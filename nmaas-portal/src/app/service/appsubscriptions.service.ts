...
export class AppSubscriptionsService extends GenericDataService {
  ...
  public getSubscribedApplications(domainId?: number): Observable<ApplicationBase[]> {
      return this.get<ApplicationBase[]>(
                      (domainId === undefined ? this.getSubscriptionsUrl() : this.getDomainSubscriptionsUrl(domainId)) + '/apps');
  }
