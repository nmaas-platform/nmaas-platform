...
public class HelmCommandPreparationTest {
    ...
    private static final String CORRECT_HELM_UPGRADE_COMMAND = "helm upgrade " + RELEASE_NAME + " " + CHART_ARCHIVE_NAME;
    private static final String CORRECT_HELM_UPGRADE_WITH_REPO_COMMAND = "helm upgrade " + RELEASE_NAME + " " + CHART_NAME_WITH_REPO + " --version " + CHART_VERSION;
    ...
    public void shouldConstructUpgradeCommandWithRepo() {
        assertThat(HelmUpgradeCommand.commandWithRepo(HelmCommand.HELM_VERSION_3, RELEASE_NAME, CHART_NAME_WITH_REPO, CHART_VERSION, true).asString(),
    ...
    public void shouldFailConstructUpgradeCommandWithRepoDueToHelmVersion() {
        assertThrows(IllegalArgumentException.class, () -> {
            HelmUpgradeCommand.commandWithRepo(HELM_VERSION_2, RELEASE_NAME, CHART_REPO_NAME, CHART_VERSION, true);
        });
    }
