...
//    Page<AppInstanceBase> findAll(Pageable pageable,String search);
...
//    Page<AppInstanceBase> findAllByOwner(User owner, Domain domain, Pageable pageable,String search);
