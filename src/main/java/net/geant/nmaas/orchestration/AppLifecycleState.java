...
public enum AppLifecycleState {
    ...
    APPLICATION_PAUSE_IN_PROGRESS {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_PAUSE_PROGRESS";
        }
    },
    APPLICATION_PAUSED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_PAUSE_SUCCESS";
        }
    },
    APPLICATION_PAUSE_FAILED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_PAUSE_FAILED";
        }
    },
    APPLICATION_RESUME_IN_PROGRESS {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_RESUME_PROGRESS";
        }
    },
    APPLICATION_RESUMED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_RESUME_SUCCESS";
        }
    },
    APPLICATION_RESUME_FAILED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_RESUME_FAILED";
        }
    },
    ...
    FAILED_APPLICATION_REMOVED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.FAILED_APPLICATION_REMOVED";
        }
    },
    APPLICATION_CONFIGURATION_REMOVAL_IN_PROGRESS {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_CONF_REMOVE_PROGRESS";
        }
    },
    APPLICATION_CONFIGURATION_REMOVED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_CONF_REMOVE_SUCCESS";
        }
    },
    APPLICATION_CONFIGURATION_REMOVAL_FAILED {
        @Override
        public String getUserFriendlyState() {
            return "APP_INSTANCE.PROGRESS.APP_CONF_REMOVE_ERROR";
        }
    };
