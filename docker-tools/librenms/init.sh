...
#add hosts from file /data/addhosts.cfg to monitoring
if [ -f /data/addhosts.cfg ] ; then
        while IFS='' read -r line || [[ -n "$line" ]]
        do
                su librenms -c "/opt/librenms/addhost.php $line"
        done < /data/addhosts.cfg
else echo "No file addhosts.cfg. Hosts not added."
fi
