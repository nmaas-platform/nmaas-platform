...
public class UserRepositoryTest {
	...
	@Test
	public void test() {
		User tester = new User("tester", "test123", domains.findDomain(DOMAIN), Role.USER);
		User admin = new User("admin", "admin123", domains.getGlobalDomain(), Role.SUPERADMIN);
		admin.getRoles().add(new UserRole(admin, domains.findDomain(DOMAIN), Role.USER));
