...
public class AppDeploymentRepositoryManagerTest {
    ...
    public void shouldAddUpdateAndRemoveAppDeployment() throws InvalidDeploymentIdException {
        ...
        assertThat(repositoryManager.loadClientIdByDeploymentId(deploymentId1), equalTo(clientId));
        assertThat(repositoryManager.loadAllWaitingForDcn(clientId).size(), equalTo(1));
        ...
        assertThat(repositoryManager.loadAllWaitingForDcn(clientId).size(), equalTo(2));
        repositoryManager.removeAll();
        assertThat(repositoryManager.loadAllWaitingForDcn(clientId).size(), equalTo(0));
    }
