...
public class DockerComposeFileTemplateAdminRestControllerTest extends BaseControllerTest {
    ...
    @Autowired
    private DockerComposeFileTemplateRepository templatesRepository;
    ...
    public void shouldStoreAndLoadTemplate() throws Exception {
        ...
        mvc.perform(post("/platform/api/management/dockercompose/templates")
                .header("Authorization", "Bearer " + token)
                .contentType(MediaType.APPLICATION_JSON)
                .content(templateJson()))
                .andExpect(status().isCreated());
        MvcResult result = mvc.perform(get("/platform/api/management/dockercompose/templates")
                .header("Authorization", "Bearer " + token))
    ...
    public void shouldAuthAndForbidSimpleGet() throws Exception {
        ...
        mvc.perform(get("/platform/api/management/dockercompose/templates")
                .header("Authorization", "Bearer " + token))
