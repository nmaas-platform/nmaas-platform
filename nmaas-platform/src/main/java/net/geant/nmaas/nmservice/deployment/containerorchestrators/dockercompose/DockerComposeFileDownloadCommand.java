...
public class DockerComposeFileDownloadCommand implements Command {
	...
	public static DockerComposeFileDownloadCommand command(
		...
		sb.append(WGET_COMMAND)
				...
				.append(targetDirectory)
				.append(targetFile);
		return new DockerComposeFileDownloadCommand(sb.toString());
	}
	...
	private DockerComposeFileDownloadCommand(String command) {
