...
public interface AppLifecycleManager {
     ...
     * @param gitLabRequired flag which indicates if GitLab instance is required during deployment
     * @return unique identifier of the deployed user application
     */
    Identifier deployApplication(String domain, Identifier applicationId, String deploymentName, boolean gitLabRequired);
