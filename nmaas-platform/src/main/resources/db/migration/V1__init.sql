...
create table app_deployment (
  id bigint generated by default as identity,
  application_id bytea(255) not null,
...
create table docker_host (
  ...
  api_ip_address bytea(255),
  api_port integer,
  base_data_network_address bytea(255),
  data_interface_name varchar(255),
  name varchar(255),
  preferred boolean not null,
  public_ip_address bytea(255),
...
create table k_cluster_api (
  id bigint generated by default as identity,
  rest_api_host_address bytea(255),
...
create table k_cluster_ext_network (
  ...
  external_ip bytea(255) not null,
  external_network bytea(255) not null,
...
create table k_cluster_helm (
  ...
  helm_host_address bytea(255) not null,
