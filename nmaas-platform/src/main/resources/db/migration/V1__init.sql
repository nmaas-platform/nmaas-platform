...
create table app_deployment (
  id bigint generated by default as identity,
  application_id binary(255) not null,
  config_file_repository_required boolean not null,
  deployment_id binary(255) not null,
...
create table app_deployment_configuration (
  id bigint generated by default as identity,
  json_input varchar(2147483647) not null, primary key (id));
...
create table docker_compose_service_service_components (
  ...
  service_components_id bigint not null);

create table docker_host (
  id bigint generated by default as identity,
  access_interface_name varchar(255),
  api_ip_address binary(255),
  api_port integer,
  base_data_network_address binary(255),
  data_interface_name varchar(255),
  name varchar(255),
  preferred boolean not null,
  public_ip_address binary(255),
...
create table docker_host_state_address_assignments (
  ...
  address_assignments_id bigint not null);

create table docker_host_state_port_assignments (
  docker_host_state_id bigint not null,
  port_assignments_id bigint not null);

create table docker_host_state_vlan_assignments (
  docker_host_state_id bigint not null,
  vlan_assignments_id bigint not null);
...
create table k_cluster_api (
  id bigint generated by default as identity,
  rest_api_host_address binary(255),
...
create table nm_service_configuration (
  id bigint generated by default as identity,
  config_file_content clob not null,
...
create table nm_service_configuration_template (
  ...
  application_id bigint not null,
  config_file_name varchar(255) not null,
  config_file_template_content clob not null,
  primary key (id));
...
alter table application drop constraint if exists UKbek0xek0mdygawapgjoxv7yx3;
alter table application add constraint UKbek0xek0mdygawapgjoxv7yx3 unique (name, version);
alter table application_screenshots drop constraint if exists UK_o1fk9wkhr4xn6i4v97w3c5xgu;
alter table application_screenshots add constraint UK_o1fk9wkhr4xn6i4v97w3c5xgu unique (screenshots_id);
alter table docker_compose_file_template_dcn_attached_containers drop constraint if exists UK_nxxmamr1g0cem52mpn0vs5doi;
alter table docker_compose_file_template_dcn_attached_containers add constraint UK_nxxmamr1g0cem52mpn0vs5doi unique (dcn_attached_containers_id);
alter table docker_compose_service_service_components drop constraint if exists UK_cxjk78nu5lld2ajp6907difyn;
alter table docker_compose_service_service_components add constraint UK_cxjk78nu5lld2ajp6907difyn unique (service_components_id);
alter table docker_host_state_address_assignments drop constraint if exists UK_6n38hvmleoerhtkl1h8brw3f5;
alter table docker_host_state_address_assignments add constraint UK_6n38hvmleoerhtkl1h8brw3f5 unique (address_assignments_id);
alter table docker_host_state_port_assignments drop constraint if exists UK_5h7bk1o9vdgjonyrwq3jxld0;
alter table docker_host_state_port_assignments add constraint UK_5h7bk1o9vdgjonyrwq3jxld0 unique (port_assignments_id);
alter table docker_host_state_vlan_assignments drop constraint if exists UK_tnipm3oka8inixjobihxoniiu;
alter table docker_host_state_vlan_assignments add constraint UK_tnipm3oka8inixjobihxoniiu unique (vlan_assignments_id);
alter table domain drop constraint if exists UKga2sqp4lboblqv6oks9oryd9q;
alter table domain add constraint UKga2sqp4lboblqv6oks9oryd9q unique (name);
alter table domain drop constraint if exists UK497u3rjin9f31mp91dfikirvr;
alter table domain add constraint UK497u3rjin9f31mp91dfikirvr unique (codename);
alter table k_cluster drop constraint if exists UK_5byl0csyag05o0yb2cia7o7nj;
alter table k_cluster add constraint UK_5byl0csyag05o0yb2cia7o7nj unique (api_id);
alter table k_cluster drop constraint if exists UK_mrs3ybfmm3f3y2nj2hso79nqf;
alter table k_cluster add constraint UK_mrs3ybfmm3f3y2nj2hso79nqf unique (deployment_id);
alter table k_cluster drop constraint if exists UK_5tuior5qy5rmx6vxj1e48yrd9;
alter table k_cluster add constraint UK_5tuior5qy5rmx6vxj1e48yrd9 unique (helm_id);
alter table k_cluster drop constraint if exists UK_9mpmpts16nasy5atb1gda0d5g;
alter table k_cluster add constraint UK_9mpmpts16nasy5atb1gda0d5g unique (ingress_id);
alter table k_cluster_external_networks drop constraint if exists UK_jqku2j34effk60e2y3bvk43lx;
