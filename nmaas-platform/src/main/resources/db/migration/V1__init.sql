...
alter table app_deployment add (logged_in_users_name varchar(255), domain_id  bigint, app_name  varchar(255), app_instance_id bigint, app_instance_name varchar(255), accessURL varchar(255));
